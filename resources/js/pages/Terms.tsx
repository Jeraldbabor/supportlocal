                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600">
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                By accessing or using SupportLocal ("the Platform"), you agree to be bound by these Terms of Service 
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                SupportLocal is an online marketplace that connects local artisans and sellers with buyers seeking 
                                unique, handmade, and locally-produced products. We provide a platform for sellers to list their 
                                products and for buyers to discover and purchase these items.
                            </p>
                        </section>

                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">3. User Accounts</h2>
                            <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Account Registration</h3>
                            <p>
                            ...
                            <h3 className="text-xl font-medium text-gray-800 mt-6 mb-3">Account Security</h3>
                            <p>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Buyer Terms</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Seller Terms</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Payments and Fees</h2>
                            <p>
                                All payments are processed securely through our payment providers. Prices are displayed in Philippine 
                                Pesos (PHP) unless otherwise stated. Sellers are responsible for any applicable taxes on their sales.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Sellers are responsible for shipping products to buyers. Shipping times and costs are determined by 
                                individual sellers. SupportLocal is not responsible for delays or issues caused by shipping carriers.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Return and refund policies may vary by seller. Please review the seller's specific policies before 
                                making a purchase. Disputes should be resolved directly between buyers and sellers, with SupportLocal 
                                providing mediation assistance when necessary.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                The Platform and its original content, features, and functionality are owned by SupportLocal and are 
                                protected by international copyright, trademark, and other intellectual property laws. Sellers retain 
                                ownership of their product listings and images but grant SupportLocal a license to display and 
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                ...
                                guarantee that the Platform will be uninterrupted, secure, or error-free. We are not responsible for 
                                the quality, safety, or legality of items listed by sellers.
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                SupportLocal shall not be liable for any indirect, incidental, special, consequential, or punitive 
                                damages arising out of your use of the Platform. Our total liability shall not exceed the amount 
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                You agree to indemnify and hold harmless SupportLocal and its officers, directors, employees, and 
