                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="prose prose-lg max-w-none text-gray-600">
                        ...
                        <section className="mb-8">
                            ...
                            <p>
                                Welcome to SupportLocal ("we," "our," or "us"). We are committed to protecting your personal information and your
                                right to privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you
                                visit our website <strong>supportlocal.shop</strong> and use our services.
                            </p>
                            <p className="mt-4">
                        ...
                        <section className="mb-8">
                            ...
                            <h3 className="mt-6 mb-3 text-xl font-medium text-gray-800">Information from Social Media</h3>
                            <p>
                                If you choose to register or log in using a social media account (such as Facebook or Google), we may receive certain
                                profile information about you from the social media provider. The information we receive may include your name, email
                                address, and profile picture. You can control what information is shared with us through your social media account
                                settings.
                            </p>

                            <h3 className="mt-6 mb-3 text-xl font-medium text-gray-800">Automatically Collected Information</h3>
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="mt-2 list-disc space-y-2 pl-6">
                                <li>
                                    <strong>With Sellers:</strong> When you make a purchase, we share necessary information with the seller to fulfill
                                    your order.
                                </li>
                                <li>
                                    <strong>Service Providers:</strong> We may share your information with third-party service providers who perform
                                    services on our behalf (payment processing, email delivery, hosting).
                                </li>
                                <li>
                                    <strong>Legal Requirements:</strong> We may disclose your information where required by law or to protect our
                                    rights.
                                </li>
                                <li>
                        ...
                        <section className="mb-8">
                            <h2 className="mb-4 text-2xl font-semibold text-gray-900">5. Cookies and Tracking Technologies</h2>
                            <p>
                                We use cookies and similar tracking technologies to collect and track information about your browsing activity.
                                Cookies are small data files stored on your device. You can instruct your browser to refuse all cookies or to indicate
                        ...
                        <section className="mb-8">
                            <h2 className="mb-4 text-2xl font-semibold text-gray-900">8. Your Rights</h2>
                            ...
                            <p className="mt-4">
                                To exercise any of these rights, please contact us using the information provided below or use the data export feature
