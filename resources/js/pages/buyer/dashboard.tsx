...
import { ArrowRight, Bell, CheckCircle, Clock, CreditCard, Flame, Heart, MapPin, Package, Shield, ShoppingBag, Star, TrendingUp, Truck, User, Zap } from 'lucide-react';
    ...
    return (
        <BuyerLayout>
            ...
            <div className="min-h-screen bg-gray-50">
                ...
                {/* Hero Section */}
                <section className="mx-2 sm:mx-4 mt-2 sm:mt-4 border-b border-gray-100 bg-white py-6 sm:py-10">
                    <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8">
                        <div className="flex flex-col items-start justify-between gap-4 sm:gap-5 sm:flex-row sm:items-center">
                            <div className="flex-1 min-w-0">
                                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 break-words">
                                    {new Date().getHours() < 12 ? 'Good Morning' : new Date().getHours() < 18 ? 'Good Afternoon' : 'Good Evening'},
                                    <span className="ml-1 sm:ml-2 bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">
                                        {user?.name}
                                    </span>
                                </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full sm:w-auto">
                                <Link
                                    href="/buyer/products"
                                    className="group inline-flex items-center justify-center rounded-lg sm:rounded-xl border-2 border-gray-300 bg-white px-4 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-gray-700 shadow-sm transition-all hover:border-gray-400 hover:bg-gray-50 hover:shadow-md"
                                >
                                    <ShoppingBag className="mr-1.5 sm:mr-2 h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform group-hover:scale-110" />
                                    Browse
                                </Link>
                                <Link
                                    href="/seller/apply"
                                    className="group inline-flex items-center justify-center rounded-lg sm:rounded-xl bg-gray-900 px-4 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-white shadow-lg transition-all hover:scale-105 hover:bg-gray-800 hover:shadow-xl"
                                >
                                    <User className="mr-1.5 sm:mr-2 h-3.5 w-3.5 sm:h-4 sm:w-4 transition-transform group-hover:scale-110" />
                ...
                <section className="mx-2 sm:mx-4 rounded-xl sm:rounded-2xl border border-gray-100 bg-white py-6 sm:py-8 shadow-sm">
                    <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8">
                        <div className="mb-6 sm:mb-8 lg:mb-12 text-center">
                            <h2 className="mb-2 sm:mb-4 text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Your Shopping Journey</h2>
                            <p className="text-sm sm:text-base lg:text-lg text-gray-600">Track your orders and shopping activity at a glance</p>
                        </div>

                        <div className="grid grid-cols-1 gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
                            {/* Orders Card */}
                            <div className="group rounded-lg sm:rounded-xl border border-amber-200 bg-gradient-to-br from-amber-50 to-orange-100 p-4 sm:p-6 transition-all duration-200 hover:shadow-lg">
                                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                                    <div className="rounded-full bg-gradient-to-r from-amber-600 to-orange-600 p-2 sm:p-3 shadow-md transition-transform duration-200 group-hover:scale-110">
                                        <ShoppingBag className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                                    </div>
                                    <TrendingUp className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-amber-700" />
                                </div>
                                <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-semibold text-gray-800">Total Orders</h3>
                                <div className="flex items-baseline space-x-1.5 sm:space-x-2">
                                    <p className="text-2xl sm:text-3xl font-bold text-amber-700">{stats.totalOrders}</p>
                                    <span className="text-xs sm:text-sm text-gray-600">orders placed</span>
                                </div>
                            ...
                            {/* Reviews Card */}
                            <div className="group rounded-lg sm:rounded-xl border border-yellow-200 bg-gradient-to-br from-yellow-50 to-amber-100 p-4 sm:p-6 transition-all duration-200 hover:shadow-lg">
                                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                                    <div className="rounded-full bg-gradient-to-r from-yellow-600 to-amber-600 p-2 sm:p-3 shadow-md transition-transform duration-200 group-hover:scale-110">
                                        <Star className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                                    </div>
                                    <Star className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-yellow-700" />
                                </div>
                                <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-semibold text-gray-800">Reviews Given</h3>
                                <div className="flex items-baseline space-x-1.5 sm:space-x-2">
                                    <p className="text-2xl sm:text-3xl font-bold text-yellow-700">{stats.totalReviews}</p>
                                    <span className="text-xs sm:text-sm text-gray-600">reviews written</span>
                                </div>
                                <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed">
                            ...
                            {/* Spending Card */}
                            <div className="group rounded-lg sm:rounded-xl border border-green-200 bg-gradient-to-br from-green-50 to-emerald-100 p-4 sm:p-6 transition-all duration-200 hover:shadow-lg">
                                <div className="mb-3 sm:mb-4 flex items-center justify-between">
                                    <div className="rounded-full bg-gradient-to-r from-green-600 to-emerald-600 p-2 sm:p-3 shadow-md transition-transform duration-200 group-hover:scale-110">
                                        <CreditCard className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
                                    </div>
                                    <TrendingUp className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-green-700" />
                                </div>
                                <h3 className="mb-1.5 sm:mb-2 text-base sm:text-lg font-semibold text-gray-800">Total Spent</h3>
                                <div className="flex items-baseline space-x-1.5 sm:space-x-2 flex-wrap">
                                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-700 break-words">{formatPeso(stats.totalSpent)}</p>
                                    <span className="text-xs sm:text-sm text-gray-600">lifetime</span>
                                </div>
                                <p className="mt-1.5 sm:mt-2 text-xs sm:text-sm text-gray-600 leading-relaxed">Supporting local artisans</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="mx-2 sm:mx-4 py-6 sm:py-8">
                    <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8">
                        <div className="rounded-xl sm:rounded-2xl border border-gray-100 bg-white p-4 sm:p-6 shadow-sm">
                            <div className="mb-4 sm:mb-6 flex items-center justify-between">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-sm sm:text-base text-gray-600">Keep track of your latest shopping activities</p>
                                </div>
                                <Clock className="h-5 w-5 sm:h-6 sm:w-6 text-gray-400 flex-shrink-0 ml-2" />
                            </div>
                            ...
                            {recentActivity.length > 0 ? (
                                <div className="space-y-3 sm:space-y-4">
                                    {recentActivity.map((activity, index) => (
                                        <div
                                            key={index}
                                            className="flex items-start gap-3 sm:gap-4 rounded-lg border border-gray-100 bg-gray-50 p-3 sm:p-4 transition-all duration-200 hover:border-amber-200 hover:bg-amber-50"
                                        >
                                            <div
                                                className={`mt-0.5 sm:mt-1 rounded-full p-1.5 sm:p-2 flex-shrink-0 ${
                                                    activity.type === 'order'
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-sm sm:text-base font-semibold text-gray-900 break-words">{activity.description}</p>
                                                    ...
                                                    <div className="text-left sm:text-right flex-shrink-0">
                                                        <p className="text-xs sm:text-sm text-gray-500">{activity.date_human}</p>
                                                        {activity.amount && (
                                                            <p className="mt-0.5 sm:mt-1 text-sm sm:text-base font-semibold text-amber-700">{formatPeso(activity.amount)}</p>
                                                        )}
                                                    </div>
                                                </div>
                                            </div>
                ...
                {/* Main Content Area */}
                <section className="mx-2 sm:mx-4 rounded-xl sm:rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 py-6 sm:py-8">
                    <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8">
                        <div className="grid gap-6 sm:gap-8 lg:grid-cols-3">
                            {/* Recent Orders - Enhanced */}
                            <div className="overflow-hidden rounded-xl sm:rounded-2xl border border-amber-200 bg-white shadow-sm transition-shadow duration-300 hover:shadow-lg lg:col-span-2">
                                <div className="border-b border-amber-100 bg-gradient-to-r from-amber-50 to-orange-50 p-4 sm:p-6">
                                    <div className="flex items-center justify-between">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs sm:text-sm text-amber-900/70">Track your recent purchases</p>
                                        </div>
                                        <Package className="h-6 w-6 sm:h-8 sm:w-8 text-amber-700 flex-shrink-0 ml-2" />
                                    </div>
                                </div>
                                    ...
                                    {recentOrders.length > 0 ? (
                                        <div className="space-y-3 sm:space-y-4">
                                            {recentOrders.map((order) => (
                                                <div
                                                    key={order.id}
                                                    className="rounded-lg border border-amber-100 bg-gradient-to-r from-amber-50 to-orange-50 p-3 sm:p-4 transition-all duration-200 hover:border-amber-300 hover:shadow-md"
                                                >
                                                    <div className="mb-2 sm:mb-3 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                                                        <div className="flex-1 min-w-0">
                                                            <h4 className="text-sm sm:text-base font-semibold text-gray-900 break-words">Order #{order.order_number}</h4>
                                                            <p className="text-xs sm:text-sm text-gray-600">From {order.seller_name}</p>
                                                        </div>
                                                        <div className="text-left sm:text-right flex-shrink-0">
                                                            <span
                                                                className={`inline-block rounded-full px-2.5 sm:px-3 py-1 text-[10px] sm:text-xs font-semibold ${
                                                            ...
                                                            <p className="mt-1 text-xs sm:text-sm text-gray-500">{order.created_at_human}</p>
                                                        </div>
                                                    </div>
                                                    <div className="mb-2 sm:mb-3 flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm text-gray-600 flex-wrap">
                                                    ...
                                                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                                                        {order.items.slice(0, 3).map((item, idx) => (
                                                            <div
                                                                key={idx}
                                                                className="rounded border border-amber-200 bg-white px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs text-gray-700 break-words"
                                                            >
                                                                {item.product_name} (x{item.quantity})
                                                            </div>
                                                        ))}
                                                        {order.items.length > 3 && (
                                                            <div className="rounded border border-amber-200 bg-white px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs text-gray-500">
