...
export default function SellerDashboard() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 sm:gap-6 overflow-x-auto rounded-xl p-3 sm:p-4">
                ...
                <div className="rounded-xl border bg-gradient-to-r from-blue-50 to-indigo-50 p-4 sm:p-6 dark:from-blue-950/20 dark:to-indigo-950/20">
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                        <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0 flex-1">
                            <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900 flex-shrink-0">
                                <Package className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 dark:text-blue-400" />
                            </div>
                            <div className="min-w-0 flex-1">
                                <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 truncate">Welcome, {user?.name}!</h1>
                                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 mt-1">
                                    Role: <span className="font-semibold text-blue-600 dark:text-blue-400">Seller/Artisan</span>
                                    {stats.days_as_seller > 0 && <span className="ml-1 sm:ml-2 text-xs sm:text-sm">• {stats.days_as_seller} days as seller</span>}
                                </p>
                                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your products, orders, and customer relationships</p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 flex-shrink-0">
                            ...
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <button
                                    ...
                                    className="flex items-center gap-1.5 sm:gap-2 rounded-lg bg-white px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm font-medium text-gray-700 shadow-sm ring-1 ring-gray-300 hover:bg-gray-50 disabled:opacity-50 dark:bg-gray-800 dark:text-gray-300 dark:ring-gray-600 dark:hover:bg-gray-700 whitespace-nowrap"
                            ...
                            <div className="w-full sm:w-auto">
                                <div className="flex items-center gap-2 mb-1.5">
                                    <span className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-300 whitespace-nowrap">Account Health</span>
                                    <div
                                        className={`flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full flex-shrink-0 ${getHealthScoreBg(stats.account_health_score)}`}
                                    >
                                        <span className={`text-xs sm:text-sm font-bold ${getHealthScoreColor(stats.account_health_score)}`}>
                                            {stats.account_health_score}%
                                        </span>
                                    </div>
                                </div>
                                <div className="h-2 w-full sm:w-24 rounded-full bg-gray-200 dark:bg-gray-700">
                                    <div
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="rounded-xl border bg-white p-4 sm:p-6 shadow-sm dark:bg-gray-800">
                        <div className="mb-4 flex items-center justify-between gap-2">
                            <h3 className="flex items-center gap-2 text-base sm:text-lg font-semibold text-gray-900 dark:text-gray-100">
                                <User className="h-4 w-4 sm:h-5 sm:w-5" />
                                Profile Completeness
                            </h3>
                            <span className="text-xl sm:text-2xl font-bold text-blue-600 dark:text-blue-400 flex-shrink-0">{profile.profile_completeness}%</span>
                        </div>
                    ...
                    <div className="rounded-xl border bg-white p-4 sm:p-6 shadow-sm dark:bg-gray-800">
                        ...
                        <div className="space-y-2.5 sm:space-y-3">
                            <div className="flex items-center justify-between gap-2 pr-1">
                                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 flex-1 min-w-0">Notifications</span>
                            ...
                            <div className="flex items-center justify-between gap-2 pr-1">
                                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 flex-1 min-w-0">Two-Factor Auth</span>
                                <div className="flex-shrink-0">
                            ...
                            <div className="flex items-center justify-between gap-2 pr-1">
                                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 flex-1 min-w-0">Privacy Settings</span>
                                <div className="flex-shrink-0">
                            ...
                            <div className="flex items-center justify-between gap-2 pr-1">
                                <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 flex-1 min-w-0">Marketing Preferences</span>
                                <div className="flex-shrink-0">
                ...
                <div className="grid auto-rows-min gap-3 sm:gap-4 md:grid-cols-2 lg:grid-cols-4">
                    {/* Products Card */}
                    <div className="group rounded-xl border bg-white p-4 sm:p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800">
                        <div className="flex items-center justify-between">
                            <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900 flex-shrink-0">
                                <Package className="h-5 w-5 sm:h-6 sm:w-6 text-blue-600 dark:text-blue-400" />
                            </div>
                            <div className="text-right min-w-0">
                                <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100">{products.total}</p>
                                <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-300">Products</p>
                            </div>
                        </div>
                        <div className="mt-3 sm:mt-4 flex items-center justify-between text-xs sm:text-sm gap-2">
                            <span className="text-green-600 dark:text-green-400 truncate" title="Active products visible to customers">
                                {products.active} Active
                            </span>
                            <span className="text-yellow-600 dark:text-yellow-400 truncate" title="Draft products not yet published">
                                {products.draft} Draft
                            </span>
                        </div>
                        {products.created_this_week > 0 && (
                            <div className="mt-2 text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">+{products.created_this_week} this week</div>
                        )}
                    </div>
                    ...
                    <div className="group rounded-xl border bg-white p-4 sm:p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800">
                        <div className="flex items-center justify-between">
                            <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-orange-100 dark:bg-orange-900 flex-shrink-0">
                                <ShoppingBag className="h-5 w-5 sm:h-6 sm:w-6 text-orange-600 dark:text-orange-400" />
                            </div>
                            <div className="text-right min-w-0">
                                <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100">{orders.total}</p>
                                <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-300">Orders</p>
                            </div>
                        </div>
                        <div className="mt-3 sm:mt-4 flex items-center justify-between text-xs sm:text-sm gap-2">
                            <span className="text-blue-600 dark:text-blue-400 truncate" title="Orders awaiting confirmation">
                                {orders.pending} Pending
                            </span>
                            <span className="text-green-600 dark:text-green-400 truncate" title="Successfully completed orders">
                                {orders.completed} Completed
                            </span>
                        </div>
                        {orders.today > 0 && <div className="mt-2 text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">+{orders.today} today</div>}
                    </div>
                    ...
                    <div className="group rounded-xl border bg-white p-4 sm:p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800">
                        <div className="flex items-center justify-between">
                            <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-green-100 dark:bg-green-900 flex-shrink-0">
                                <PesoIcon className="h-5 w-5 sm:h-6 sm:w-6 text-green-600 dark:text-green-400" />
                            </div>
                            <div className="text-right min-w-0">
                                <p
                        ...
                        <div className="mt-3 sm:mt-4 flex items-center justify-between text-xs sm:text-sm gap-2">
                            <span className="text-blue-600 dark:text-blue-400 truncate text-[10px] sm:text-xs" title="Revenue this month">
                                {formatCurrency(revenue.this_month)} MTD
                            </span>
                            {revenue.month_growth_percentage !== 0 && (
                                <div
                                    className={`flex items-center gap-1 flex-shrink-0 ${getGrowthColor(revenue.month_growth_percentage)}`}
                                ...
                                >
                                    ...
                                    <span className="text-[10px] sm:text-xs font-medium">{formatPercentage(revenue.month_growth_percentage)}</span>
                                </div>
                            )}
                        </div>
                        {revenue.pending_amount > 0 && (
                            <div className="mt-2 text-[10px] sm:text-xs text-yellow-600 dark:text-yellow-400 truncate" title="Revenue from pending orders">
                    ...
                    <div className="group rounded-xl border bg-white p-4 sm:p-6 shadow-sm transition-all hover:shadow-md dark:bg-gray-800">
                        <div className="flex items-center justify-between">
                            <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900 flex-shrink-0">
                                <Users className="h-5 w-5 sm:h-6 sm:w-6 text-purple-600 dark:text-purple-400" />
                            </div>
                            <div className="text-right min-w-0">
                                <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100">{customers.total_unique}</p>
                                <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-300">Customers</p>
                            </div>
                        </div>
                        <div className="mt-3 sm:mt-4 flex items-center justify-between text-xs sm:text-sm gap-2">
                            <span className="text-green-600 dark:text-green-400 truncate" title="Customers who made multiple purchases">
                                {customers.returning} Returning
                            </span>
                            <span className="text-blue-600 dark:text-blue-400 truncate" title="Customer retention rate">
                                {customers.retention_rate}% Retention
                            </span>
                        </div>
                        {customers.new_this_month > 0 && (
                            <div className="mt-2 text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">+{customers.new_this_month} this month</div>
                        )}
                    </div>
                </div>
