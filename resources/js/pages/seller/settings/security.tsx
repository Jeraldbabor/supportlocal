...
import { AlertTriangle, CheckCircle, Clock, Eye, EyeOff, Key, Lock, Mail, Save, Shield, Smartphone, Trash2 } from 'lucide-react';
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
                ...
                <div className="rounded-xl border bg-gradient-to-r from-blue-50 to-indigo-50 p-6 dark:from-blue-950/20 dark:to-indigo-950/20">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="mt-1 text-gray-600 dark:text-gray-300">Manage your account security and authentication</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-4">
                    ...
                    <div className="rounded-xl border bg-white p-4 dark:bg-gray-800">
                        <div className="flex items-center gap-3">
                            <div
                                className={`rounded-full p-2 ${user.two_factor_enabled ? 'bg-green-100 dark:bg-green-900' : 'bg-yellow-100 dark:bg-yellow-900'}`}
                            >
                                <Smartphone
                                    className={`h-5 w-5 ${user.two_factor_enabled ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400'}`}
                                />
                            </div>
                            <div>
                    ...
                    <div className="rounded-xl border bg-white p-4 dark:bg-gray-800">
                        <div className="flex items-center gap-3">
                            <div
                                className={`rounded-full p-2 ${user.email_verified_at ? 'bg-green-100 dark:bg-green-900' : 'bg-red-100 dark:bg-red-900'}`}
                            >
                                <Mail
                                    className={`h-5 w-5 ${user.email_verified_at ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                                />
                            </div>
                            <div>
                    ...
                    <div className="rounded-xl border bg-white p-4 dark:bg-gray-800">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold text-gray-900 dark:text-gray-100">{securityInfo.active_sessions_count} Active</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="rounded-xl border bg-white p-6 dark:bg-gray-800">
                        ...
                        <form onSubmit={handlePasswordSubmit} className="space-y-6">
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full rounded-lg border-gray-300 pr-10 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                                        required
                                    />
                                    <button
                                        type="button"
                            ...
                            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-700">
                                <h4 className="mb-2 text-sm font-medium text-gray-900 dark:text-gray-100">Password Requirements:</h4>
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 disabled:opacity-50"
                            >
                    ...
                    <div className="space-y-6">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {!user.email_verified_at && (
                                        <button
                                            ...
                                            disabled={processing}
                                            className="rounded-lg bg-blue-100 px-3 py-1 text-sm font-medium text-blue-700 hover:bg-blue-200 dark:bg-blue-900 dark:text-blue-300"
                                        >
                                            Verify Now
                                        </button>
                                    )}
                        ...
                        <div className="rounded-xl border bg-white p-6 dark:bg-gray-800">
                            ...
                            <div className="mt-4 space-y-3 border-t pt-4 dark:border-gray-700">
                                <button className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600">
                                ...
                                <button
                                    ...
                                    className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-red-100 px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-200 dark:bg-red-900 dark:text-red-200 dark:hover:bg-red-800"
                                >
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <form onSubmit={handleConfirmDelete} className="space-y-4">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <div className="text-sm">
                                    ...
                                    <p className="mt-1 text-red-700 dark:text-red-300">
                                        Deleting your account will remove all your profile data, seller applications, and business information
                                        permanently.
                                    </p>
                                </div>
                            </div>
                        ...
                        <DialogFooter className="flex gap-2 sm:gap-2">
                            <Button type="button" variant="outline" onClick={handleCancelDelete} disabled={deleteProcessing}>
                                Cancel
                            </Button>
                            <Button
                                type="submit"
