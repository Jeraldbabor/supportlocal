                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="text-center">
                                <p className="text-sm text-muted-foreground">Upload a new profile picture. Max file size: 2MB</p>
                                <p className="mt-1 text-xs text-muted-foreground">Supported formats: JPEG, PNG, JPG, GIF</p>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <p className="text-sm text-muted-foreground">Optional delivery details for orders</p>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div className="space-y-2">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <p className="text-sm text-muted-foreground">GCash details for payments</p>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div className="space-y-2">
                                ...
                                <CardContent>
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Please verify your email to access all features.</p>
                                        </div>
