        ...
        return (
            <div className="rounded-xl border bg-white p-4 dark:bg-gray-800">
                <div className="mb-3 flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold text-blue-600 dark:text-blue-400">{completeness}%</span>
                </div>
            ...
            {missingFields.length > 0 && (
                <div className="mt-4 rounded-lg bg-amber-50 p-3 dark:bg-amber-950/20">
                    <div className="mb-1 flex items-center gap-2">
                        ...
                        <p className="text-sm font-medium text-amber-700 dark:text-amber-300">Incomplete Fields</p>
                    </div>
                    <p className="text-xs text-amber-600 dark:text-amber-400">{missingFields.join(', ')}</p>
                </div>
            )}
        </div>
    );
    ...
    return (
        <div className="rounded-xl border bg-white p-6 shadow-sm dark:bg-gray-800">
            ...
            <div className="h-3 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                <div className={`h-3 rounded-full transition-all duration-500 ${colors.bg}`} style={{ width: `${score}%` }}></div>
            </div>
