...
export default function StartChatButton({ userId, productId, className = '', variant = 'default', children }: StartChatButtonProps) {
    ...
    return (
        <>
            <Button onClick={handleStartChat} disabled={isLoading} variant={variant} className={className}>
                {children || (
                    <>
