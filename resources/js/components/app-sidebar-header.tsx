...
export function AppSidebarHeader({ breadcrumbs = [] }: { breadcrumbs?: BreadcrumbItemType[] }) {
    ...
    return (
        <header className="flex h-14 shrink-0 items-center gap-2 border-b border-sidebar-border/50 bg-gradient-to-r from-background to-background/95 px-3 backdrop-blur-sm transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 sm:h-16 sm:gap-3 sm:px-4 md:px-5 lg:px-6">
