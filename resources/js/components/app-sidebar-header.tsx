    ...
    return (
        <header className="flex h-16 shrink-0 items-center gap-3 border-b border-sidebar-border/50 bg-gradient-to-r from-background to-background/95 px-6 backdrop-blur-sm transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-5">
            <div className="flex flex-1 items-center gap-3">
                <SidebarTrigger className="-ml-1 hover:bg-sidebar-accent/70 transition-colors duration-200 rounded-md" />
            ...
            <div className="flex items-center gap-3">
                {showNotifications && (
                    <Link
                        ...
                        className="group relative rounded-xl p-2.5 text-sidebar-foreground/60 transition-all duration-200 hover:bg-sidebar-accent hover:text-sidebar-foreground hover:scale-105 active:scale-95"
                        title="Notifications"
                    >
                        <Bell className="h-5 w-5 transition-transform duration-200 group-hover:rotate-12" />
                        {unreadCount > 0 && (
                            <span className="absolute -top-0.5 -right-0.5 flex h-5 min-w-[20px] items-center justify-center rounded-full bg-gradient-to-br from-red-500 to-red-600 px-1.5 py-0.5 text-[10px] font-bold text-white shadow-lg shadow-red-500/50 ring-2 ring-background animate-pulse">
