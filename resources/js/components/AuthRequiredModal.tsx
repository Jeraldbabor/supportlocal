            ...
            >
                ...
                <div className="mb-4 flex justify-center">
                    <div className="rounded-full bg-orange-100 p-4">
                        <LogIn className="h-10 w-10" style={{ color: '#ea580c' }} />
                    </div>
                </div>
                ...
                <div className="text-center">
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            onClick={handleLogin}
                            className="flex w-full transform items-center justify-center gap-2 rounded-lg bg-orange-600 px-6 py-3 text-base font-semibold text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-orange-700 hover:shadow-lg focus:ring-2 focus:ring-orange-500/50"
                        >
                        ...
                        <button
                            ...
                            className="flex w-full transform items-center justify-center gap-2 rounded-lg border-2 border-orange-600 bg-white px-6 py-3 text-base font-semibold shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:bg-orange-50 hover:shadow-md focus:ring-2 focus:ring-orange-500/50"
                            style={{ color: '#ea580c' }}
                        >
                            <UserPlus className="h-5 w-5" style={{ color: '#ea580c' }} />
                            Create Account
                        </button>
