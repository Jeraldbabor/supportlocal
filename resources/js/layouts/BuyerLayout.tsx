...
import { Bell, Briefcase, ChevronDown, Heart, House, LogOut, Menu, Package, ShoppingCart, User, X, Phone, Contact  } from 'lucide-react';
...
function BuyerLayoutContent({ children, title }: BuyerLayoutProps) {
    ...
    const { auth, profileCompletion } = usePage<SharedData & {
        profileCompletion?: {
            status: any;
            recommendation: any;
        };
    ...
    return (
        <div className="min-h-screen bg-background">
                        ...
                        <div className="flex items-center space-x-1">
                            ...
                            <div className="relative" ref={userMenuRef}>
                                <button
                                    ...
                                    className={`flex items-center space-x-2 rounded-xl p-2 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 ${
                                        isUserMenuOpen
                                ...
                                >
                                    <Avatar className="h-9 w-9 ring-2 ring-gray-100 hover:ring-primary/30 transition-all duration-300">
                                        <AvatarImage
                                    ...
                                    <div className="hidden text-left sm:block">
                                        ...
                                        <p className="text-xs text-gray-500 font-medium">Buyer Account</p>
                                    </div>
                                    <ChevronDown
                                ...
                                {isUserMenuOpen && (
                                    <div 
                                        className="absolute top-full right-0 z-50 mt-3 w-64 rounded-xl border border-gray-200/80 bg-white/95 backdrop-blur-sm py-2 shadow-xl ring-1 ring-black/5"
                                        role="menu"
            ...
            {profileCompletion && profileCompletion.status && 
                    ...
                    <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
                        <ProfileCompletionBanner
                            ...
                            dismissible={
                                ...
                                profileCompletion.status.is_complete || 
                    ...
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className="mb-6 text-gray-300 leading-relaxed">
                                Your trusted marketplace for authentic, handcrafted products from talented local artisans. Every purchase supports creative communities.
                            </p>
